...
BEGIN
    ...
    DELETE FROM given_name_ratings WHERE user_id = p_user_id;
    ...
    DELETE FROM custom_given_names WHERE user_id = p_user_id;
    DELETE FROM user_given_names_states WHERE user_id = p_user_id;
END;
$$ LANGUAGE plpgsql;