DROP FUNCTION IF EXISTS get_unbridged_pageids_with_no_title(INT);

CREATE OR REPLACE FUNCTION get_unbridged_pageids_with_no_title(p_limit INT)
RETURNS TABLE (
"pageid" INT,
"title" TEXT,
"resolved_title" TEXT,
